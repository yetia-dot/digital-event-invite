          ...
          {!submitted ? (
            <form onSubmit={handleRsvpSubmit} className="space-y-5">
              ...
              {isGoing !== null && (
                <div className="space-y-4 pt-2">
                  ...
                  <div>
                    <label className="block text-[10px] uppercase tracking-widest text-stone-400 mb-1 font-medium pl-1">Phone Number</label>
                    <input 
                      type="text" 
                      value={phone}
            ...
            <div className="text-center space-y-4 py-8 animate-fade-in">
              ...
              <p className="text-sm text-stone-500 dark:text-stone-400 font-light max-w-xs mx-auto leading-relaxed">
                {isGoing 
                  ? "Your response has been saved perfectly. We can't wait to share this beautiful milestone with you."
